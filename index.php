...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <div class="image">
        ...
        <div class="center_img">
          ...
          <div class="center_img_right">
            <div class="center_img_right_up">
              ...
              <div class="center_img_right_up_right">
                <div class="center_img_right_up_right_up">
                  <div class="center_img_right_up_right_up_left">
            ...
            <div class="center_img_right_bottom">
              <div class="center_img_right_bottom_left">
                <p>Мы предоставляем услуги, соответствующие нашим квалификациям, и применяем наш практический опыт и экспертизу в строительстве промышленных и коммерческих объектов в ЦФО. 
      ...
      <div class="weAreBuilding">
        <h1>Мы строим</h1>
        <div class="weAreBuildingData">
          <div class="weAreBuildingDataList">
            <div class="weAreBuildingDataListLeft">
              <div class="weAreBuildingDataListLeftUp">
                <p>Коммерческие здания:</p>
                <li>производственно-складские</li>
                <li class="red">комплексы</li>
                <li>административно-бытовые</li>
                <li class="red">комплексы</li>
                <li>офисные здания и центры</li>
                <li>административные здания</li>
                <li>гостиничные комплексы</li>
                <li>склады и логистические комплексы</li>
                <li>ангары и хранилища</li>
                <li>сельскохозяйственные сооружения</li>
                <li>животноводческие комплексы</li>
                <li>овощехранилища и агрокомплексы</li>
                <li>холодильные комплексы</li>
              </div>
              <div class="weAreBuildingDataListLeftBottom">
                <p>Автомобильный бизнес:</p>
                <li>автосалоны</li>
                <li>дилерские центры</li>
                <li>автосервисы</li>
                <li>автомойки</li>
                <li>станции технического обслуживания</li>
                <li>гаражи и гаражные комплексы</li>
                <li>пассажирские автостанции</li>
              </div>
            </div>
            <div class="weAreBuildingDataListRight">
              <div class="weAreBuildingDataListRightUp">
                <p>Торговые здания:</p>
                <li>супермаркеты и магазины</li>
                <li>торговые центры</li>
                <li>торговые павильоны</li>
                <li>торговые ряды и площадки</li>
                <li>шоурумы</li>
                <li>выставочные центры</li>
              </div>
              <div class="weAreBuildingDataListRightCenter">
                <p>Спортивные сооружения:</p>
                <li>спорткомплексы</li>
                <li>тренажерные залы</li>
                <li>конно-спортивные манежи</li>
                <li>ипподромы</li>
              </div>
              <div class="weAreBuildingDataListRightBottom">
                <p>Промышленные здания и сооружения:</p>
                <li>автозаправочные станции АЗС</li>
                <li>нефтебазы и битумохранилища</li>
                <li>производственные комплексы</li>
                <li>автоналивные эстакады</li>
                <li>насосные станции</li>
                <li>пожарные станции</li>
