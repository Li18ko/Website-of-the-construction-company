  ...
  <body>
    ...
    <main>
        <div class="construction">
            <div class="constructionAndInstallationWorks">
                <div class="constructionAndInstallationWorks_left">
                    <h1>Строительно-монтажные работы</h1>
                    <div class="constructionAndInstallationWorks_left_Data">
                        <div class="constructionAndInstallationWorks_left_Data_left">
                            <div class="constructionAndInstallationWorks_left_Data_left_up">
                                <p>Монтажные и сварочные работы:</p>
                                <li>монтаж металлоконструкций</li>
                                <li>монтаж резервуаров</li>
                                <li>установка технологического </li>
                                <li class="red">оборудования</li>
                                <li>технологические трубопроводы</li>
                                <li>сварочные работы</li>
                                <li>утепление, покраска, огнезащита</li>
                            </div>
                            <div class="constructionAndInstallationWorks_left_Data_left_bottom">
                                <p>Инженерные сети:</p>
                                <li>электромонтажные работы</li>
                                <li>отопление и вентиляция </li>
                                <li>ливневые канализации</li>
                                <li>кровельные работы</li>
                                <li>технологические трубопроводы</li>
                                <li>пожарные трубопроводы</li>
                                <li>очистные сооружения</li>
                            </div>
                        </div>
                        <div class="constructionAndInstallationWorks_left_Data_right">
                            <div class="constructionAndInstallationWorks_left_Data_right_up">
                                <p>Реконструкции и ремонт:</p>
                                <li>реконструкция здания и сооружений</li>
                                <li>модернизация и техперевооружение</li>
                                <li>демонтажные работы</li>
                                <li>капитальный и текущий ремонт</li>
                                <li>ребрендинг АЗС</li>
                            </div>
                            <div class="constructionAndInstallationWorks_left_Data_right_bottom">
                                <p>Общестроительные работы:</p>
                                <li>генподряд</li>
                                <li>проектирование</li>
                                <li>земляные работы</li>
                                <li>фундаментальные работы</li>
                                <li>фасадные работы</li>
                                <li>кровельные работы</li>
                                <li>малоэтажные работы</li>
                            </div>
                        </div>
                    </div>
            ...
            <div class="productionOfMetalStructures">
                <h1>Производство металлоконструкций</h1>
                <div class="productionOfMetalStructures_Data">
                    <div class="productionOfMetalStructures_Data_left">
                        <div class="productionOfMetalStructures_Data_left_up">
                            <p>Сварные металлоконструкции:</p>
                            <li>строительство металлоконструкций</li>
                            <li>несущие каркасы зданий и сооружений</li>
                            <li>нестандартные металлоконструкции</li>
                            <li>сварные балки</li>
                            <li>фермы, колонны, связи и т.д.</li>
                            <li>закладные детали и рамы</li>
                        </div>
                        <div class="productionOfMetalStructures_Data_left_bottom">
                            <p>Емкостное и трубное оборудование:</p>
                            <li>емкости для канализации</li>
                            <li>металлические кессоны для скважины</li>
                            <li>баки прямоугольные</li>
                            <li>резервуары прямоугольные</li>
                            <li>пожарные резервуары</li>
                            <li>бункеры</li>
                            <li>расширительные баки</li>
                        </div>
                    </div>
                    <div class="productionOfMetalStructures_Data_center">
                        <div class="productionOfMetalStructures_Data_center_up">
                            <p>Закладные детали:</p>
                            <li>армирующие закладные</li>
                            <li>опалубочные закладные</li>
                            <li>технологические закладные</li>
                            <li>закладные оборудования</li>
                            <li>закладные основы</li>
                            <li>анкерные блоки и рамы</li>
                            <li>сальники набивные и прижимные</li>
                        </div>
                        <div class="productionOfMetalStructures_Data_center_bottom">
                            <p>Технологические металлоконструкции:</p>
                            <li>лестницы </li>
                            <li>ограждения и перила</li>
                            <li>технологические переходы</li>
                            <li>площадки технического обслуживания</li>
                            <li>эстакады</li>
                            <li>высотные опоры</li>
                            <li>вышки и башни</li>
                        </div>
                    </div>
                    <div class="productionOfMetalStructures_Data_right">
                        <div class="productionOfMetalStructures_Data_right_up">
                            <p>Трубопроводы технологические:</p>
                            <li>технологические трубопроводы</li>
                            <li>трубопроводы с обогреваемой</li>
                            <li class="red">рубашкой “труба в трубе”</li>
                            <li>опоры трубопроводов</li>
                            <li>элементы трубопроводов</li>
                            <li>сальники</li>
                            <li>регистры отопления</li>
                        </div>
                        <div class="productionOfMetalStructures_Data_right_bottom">
                            <p>Нестандартные изделия:</p>
                            <li>кнехты и швартовые тумбы</li>
                            <li>светопрозрачные конструкции</li>
                            <li>рекламные конструкции</li>
                            <li>шахты лифта</li>
                            <li>технологические тележки</li>
                            <li>формы для ЖБИ изделий и свай</li>
                            <li>контейнеры, ящики, шкафы</li>
                        </div>
                    </div>
            ...
            <div class="examplesOfWorks">
                <h1>Примеры работ</h1>
                <div class="examplesOfWorksData">
                    <div class="examplesOfWorksData_left">
                        <a href="#" class="toggle-link" data-target="FoundationWorks">Фундаментные работы</a>
                        <a href="#" class="toggle-link" data-target="InstallationOfMetalStructures">Монтаж металлоконструкций</a>
                        <a href="#" class="toggle-link" data-target="ManufactureAndInstallationOfSilosRVS_CSG">Изготовление и монтаж силосов, РВС и РГС</a>
                        <a href="#" class="toggle-link" data-target="InstallationOfTanks">Монтаж резервуаров</a>
                        <a href="#" class="toggle-link" data-target="InstallationOfTechnologicalPipelines">Монтаж технологических трубопроводов</a>
                        <a href="#" class="toggle-link" data-target="FacadeAndExteriorWorks">Фасадные и наружные работы</a>
                    </div>
                    <div class="examplesOfWorksData_right">
                    <a href="#" class="toggle-link" data-target="RoofingWorks">Кровельные работы</a>
                    <a href="#" class="toggle-link" data-target="ReconstructionAndDismantlingWorks">Реконструкция и демонтажные работы</a>
                    <a href="#" class="toggle-link" data-target="Landscaping">Благоустройство</a>
                    <a href="#" class="toggle-link" data-target="EngineeringСommunications">Инженерные коммуникации</a>
                    <a href="#" class="toggle-link" data-target="FinishingWorks">Отделочные работы</a>
                    </div>
                </div>
